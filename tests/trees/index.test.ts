...
suite("test trees", () => {
  it.for([
    [
      "action-basic",
      "creates an action from a file in the `actions` directory",
    ],
    [
      "action-ignores-nested",
      "only looks in the top-level `actions` directory",
    ],
    [
      "action-options",
    ...
    [
      "page-collision",
      "uniquifies spec names that collide after pascal-casing",
    ],
    [
      "page-deburr",
